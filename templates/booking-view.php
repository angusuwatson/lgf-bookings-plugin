        ...
        <div class="simple-hotel-crm-modal-dialog">
            ...
            <form class="simple-hotel-crm-quick-booking-form">
                ...
                <div class="simple-hotel-crm-form-grid simple-hotel-crm-form-grid-2">
                    ...
                    <p><label><?php esc_html_e( 'Adults', 'simple-hotel-crm' ); ?><input type="number" name="adults" min="0" class="small-text" /></label></p>
                    <p><label><?php esc_html_e( 'Children', 'simple-hotel-crm' ); ?><input type="number" name="children" min="0" class="small-text" /></label></p>
                    <p><label><?php esc_html_e( 'Babies', 'simple-hotel-crm' ); ?><input type="number" name="babies" min="0" class="small-text" /></label></p>
                </div>
