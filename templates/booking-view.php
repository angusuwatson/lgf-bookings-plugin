                ...
                ?>
                    <tr class="summary-row summary-<?php echo esc_attr( sanitize_title( $key ) ); ?>">
                        ...
                        <?php foreach ( $days as $day ) :
                            ...
                            $display = $value;
                            if ( in_array( $key, [ 'income_day', 'extras_day', 'rate_day', 'income_accumulated', 'booking_payment', 'booking_accumulated' ], true ) ) {
                        ...
                        $footer_display = in_array( $key, [ 'income_day', 'extras_day', 'rate_day', 'income_accumulated', 'booking_payment', 'booking_accumulated' ], true )
        ...
        <div class="simple-hotel-crm-modal-dialog">
            ...
            <form class="simple-hotel-crm-quick-booking-form">
                ...
                <div class="simple-hotel-crm-form-grid simple-hotel-crm-form-grid-3">
                    ...
                    <p><label><?php esc_html_e( 'Country', 'simple-hotel-crm' ); ?><span class="simple-hotel-crm-copy-field"><input type="text" name="country" class="regular-text" size="4" maxlength="4" /><button type="button" class="button button-small simple-hotel-crm-copy-button" data-copy-target="country"><?php esc_html_e( 'Copy', 'simple-hotel-crm' ); ?></button></span></label></p>
